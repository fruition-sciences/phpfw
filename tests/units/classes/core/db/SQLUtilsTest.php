...
class SQLUtilsTest extends \PHPUnit_Framework_TestCase {
     ...
     * @todo Implement testConvertTime().
     */
     ...
     * @todo Implement testConvertLong().
     */
     ...
     * @todo Implement testConvertDouble().
     */
     ...
     * @todo Implement testConvertBoolean().
     */
     ...
     * @todo Implement testConvertGeom().
     */
